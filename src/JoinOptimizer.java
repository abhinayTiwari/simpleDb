...
public class JoinOptimizer {
    ...
    */
     ...
     * algorithm (or algorithms) that you implemented for assignment 2.  It
    ...
    public double estimateJoinCost(LogicalJoinNode j, int card1, int card2, double cost1, double cost2) {
        if (j instanceof LogicalSubplanJoinNode) {
        	...
        	// You do not need to implement proper support for these for assignment 4.
    ...
    */
    ...
    {
        //Not necessary for assignments 1--3
